            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <form action="{{ route ('update.product')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h6 class="text-center text-uppercase">Update Product Form</h6>
                        <hr />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select type="text" name="type_id" value="{{ $product->type_id }}" class="form-select"
                                    ...
                                    <option value="{{$types->id}}" <?php
                                                                    if (!empty($types->id) && $types->id == $product->type_id) {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>{{$types->product_type}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
